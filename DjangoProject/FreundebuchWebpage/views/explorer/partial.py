...
def first(request) -> HttpResponse:
    ...
    if source_entry:
        source_entry.rendered_custom_field = custom_field_mapping.render_field_str(source_entry.custom_field_mode, source_entry)
    context = {
...
def next_entry(request, source_id: int) -> HttpResponse:
    ...
    if source_entry:
        ...
        try:
            ...
            current_entry.rendered_custom_field = custom_field_mapping.render_field_str(current_entry.custom_field_mode, current_entry)
...
def previous_entry(request, source_id: int) -> HttpResponse:
    ...
    if source_entry:
        ...
        try:
            ...
            previous_entry_object.rendered_custom_field = custom_field_mapping.render_field_str(previous_entry_object.custom_field_mode, previous_entry_object)
        except EntryV1.DoesNotExist:
